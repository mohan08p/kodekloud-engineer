...
TASK [Copy a file to app server] ******************************************************************************************************************************************************************************************************
changed: [stapp01]
...
5. Now to validate login to any of the app server and check the if the file present,

```
[root@stapp01 tony]# cd /opt/data/

[root@stapp01 src]# ls -ltr
total 8
drwxr-xr-x 2 root root 4096 Oct 01  2020 index.html
```
